...
export default function NotificationBell() {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div className="absolute right-0 z-50 mt-2 w-[calc(100vw-2rem)] max-w-sm overflow-hidden rounded-xl border border-gray-100 bg-white shadow-xl sm:w-96 sm:max-w-none">
