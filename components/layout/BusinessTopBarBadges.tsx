...
export default function BusinessTopBarBadges({ companyName, financialYear }: { companyName: string; financialYear: string }) {
  return (
    <>
      <span className="max-w-[60vw] truncate rounded-lg border border-blue-200 bg-blue-50 px-3 py-1.5 text-sm font-medium text-brand-blue lg:max-w-none">{companyName}</span>
