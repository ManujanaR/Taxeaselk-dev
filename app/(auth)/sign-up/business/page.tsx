      ...
      <div className="flex flex-col justify-center px-8 py-12 md:px-20">
        ...
        <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-5">
          <Field label="Company name">
            <Input value={form.companyName} onChange={(e) => update("companyName", e.target.value)} placeholder="ABC (Pvt) Ltd" required />
          </Field>
          <Field label="Your name">
            <Input value={form.fullName} onChange={(e) => update("fullName", e.target.value)} placeholder="Finance Director" required autoComplete="name" />
          </Field>
          <Field label="Email">
            <Input type="email" value={form.email} onChange={(e) => update("email", e.target.value)} placeholder="you@company.com" required autoComplete="email" />
          </Field>
